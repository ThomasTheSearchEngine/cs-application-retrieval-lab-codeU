...
public class JedisIndex {
   ...
   public Map<String, Double> getCounts(String term) {
      ...
      // System.out.println( termCounterKeys().size() );
      // System.out.println( urls.size() );
      Double idf = Math.log( termCounterKeys().size() / urls.size() );
      // System.out.println ( idf );

      for (String url: urls) {
         Double count = getCount(url, term) * idf;
         map.put(url, count);
      }
   ...
   public List<Object> pushTermCounterToRedis(TermCounter tc) {
      ...
      for (String term: tc.keySet()) {
         ...
         t.hset(hashname, term, Double.toString(count));
   ...
   public static void main(String[] args) throws IOException {
      ...
      Map<String, Double> map = index.getCountsFaster("constraints");
   ...
   private static void loadIndex(JedisIndex index) throws IOException {
      ...
      /*for (String string: index.termCounterKeys() ) {
